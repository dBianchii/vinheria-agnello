...
type Seeder = (typeof wines.$inferInsert & {
  id: number;
  grapes: (typeof grapes.$inferSelect.name)[];
  harmonizacao: (typeof harmonizations.$inferSelect.name)[];
})[];
const _wines = [
  {
    ...
    harmonizacao: ["Carnes vermelhas", "Massas ou pizzas", "Queijos"],
  },
  {
    ...
    harmonizacao: ["Carnes vermelhas", "Massas ou pizzas"],
  },
  {
  ...
  },
  {
    ...
    harmonizacao: ["Carnes brancas", "Saladas ou aperitivos"],
  },
  {
    ...
    harmonizacao: ["Carnes brancas", "Frutos do mar", "Saladas ou aperitivos"],
  },
  {
  ...
  },
  {
    ...
    grapes: ["Tempranillo", "Malbec", "Cabernet Sauvignon"],
  ...
  },
  {
    ...
    grapes: ["Antão Vaz", "Verdelho", "Arinto", "Alicante Branco", "Tamarez"],
    pais: "Portugal",
    stars: 4.8,
    unidades: 1,
    ...
    harmonizacao: ["Carnes brancas", "Frutos do mar", "Massas ou pizzas"],
  },
  {
    name: "Alísios Brut",
    ...
    grapes: ["Verdejo", "Sauvignon Blanc", "Chenin Blanc"],
    pais: "Brasil",
    stars: 4.4,
    unidades: 1,
    ...
    harmonizacao: ["Carnes brancas", "Frutos do mar", "Queijos", "Risotos"],
  },
  {
  ...
  },
  {
    ...
    harmonizacao: ["Frutos do mar", "Saladas ou aperitivos"],
  },
  {
    name: "Alísios Moscatel",
    img: "https://res.cloudinary.com/evino/image/upload/q_auto:good,fl_progressive:steep,f_auto,dpr_1.0,h_434/v1/products/1000002345-standing-front.png",
  ...
  },
  {
    ...
    harmonizacao: ["Carnes de caça", "Massas ou pizzas", "Queijos"],
  },
  {
  ...
  },
  {
    ...
    grapes: ["Airén", "Chardonnay", "Syrah", "Merlot", "Carménère"],
    ...
    harmonizacao: ["Saladas ou aperitivos", "Carnes brancas"],
  },
  {
    ...
    harmonizacao: ["Carnes vermelhas", "Queijos", "Massas ou pizzas"],
  },
].map((x, i) => ({ ...x, id: i }) as Seeder[0]);
